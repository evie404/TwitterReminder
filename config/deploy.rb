...
set :application, "TwitterReminder"
...
role :web, "TwitterReminder.com"                          # Your HTTP server, Apache/etc
role :app, "TwitterReminder.com"                         # This may be the same as your `Web` server
role :db,  "TwitterReminder.com"   , :primary => true # This is where Rails migrations will run
